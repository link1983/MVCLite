<%@ Page Title="Comment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MVCLite.Web.Comment.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="articleid" HeaderText="articleid" SortExpression="articleid" ItemStyle-HorizontalAlign="Center"  /> 
