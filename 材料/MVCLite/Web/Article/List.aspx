<%@ Page Title="Article" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MVCLite.Web.Article.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="levelMax" HeaderText="levelMax" SortExpression="levelMax" ItemStyle-HorizontalAlign="Center"  /> 
